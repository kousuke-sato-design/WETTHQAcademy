...
<svelte:head>
	<title>新規コンテンツ作成 - 専用コンテンツ - WEBTHQAcademy</title>
</svelte:head>
...
<Layout user={data.user}>
	<div class="max-w-4xl mx-auto">
		...
		<div class="mb-8">
			...
			<p class="text-gray-600">自社専用の学習コンテンツを作成します</p>
		</div>
		...
		{#if form?.success}
			<div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
				...
				<a href="/company/company-contents" class="text-green-600 underline text-sm">
					コンテンツ一覧に戻る
				</a>
			</div>
		{/if}
